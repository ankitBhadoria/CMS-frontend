...
import { usePersistState } from "use-persist"; // ✅ Correct import
...
export const AuthProvider = ({ children }) => {
    let [authTokens, setAuthTokens] = usePersistState({ key: "authTokens" }, null); // ✅ Corrected usage
    let [user, setUser] = usePersistState({ key: "user" }, null); // ✅ Corrected usage
